...
namespace Application.Interface.Services
{
    public interface IProvaService : IDisposable
    {
        ...
        Task<IEnumerable<string>> GetBancas(string provas, string materias, string assuntos, string tipos);
        Task<IEnumerable<string>> GetProvas(string bancas, string materias, string assuntos, string tipos);
        Task<IEnumerable<string>> GetMaterias(string bancas, string provas, string assuntos, string tipos);
        Task<IEnumerable<string>> GetAssuntos(string bancas, string provas, string materias, string tipos);
        Task<IEnumerable<string>> GetTipos(string bancas, string provas, string materias);
    }
}
