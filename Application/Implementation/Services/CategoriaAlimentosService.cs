...
using IService = Application.Interface.Services.ICategoriaAlimentosService;
using IRepository = Application.Interface.Repositories.ICategoriaAlimentosRepository;
using IRepositoryCodes = Application.Interface.Repositories.ICodigosTableRepository;

namespace Application.Implementation.Services
{
    public class CategoriaAlimentosService : IService
    {
        private readonly IRepository _repository;
        private readonly IRepositoryCodes _repositoryCodes;
        public CategoriaAlimentosService(IRepository repository, IRepositoryCodes repositoryCodes)
        {
