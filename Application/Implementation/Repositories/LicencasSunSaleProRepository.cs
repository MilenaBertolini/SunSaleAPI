...
{
    public class LicencasSunSaleProRepository : RepositoryBase<Main>, IRepository
    {
        private static readonly string includes = "";

        public LicencasSunSaleProRepository(DataContext dataContext) : base(dataContext)
        {
        }
        ...
        {
            var query = GetQueryable().Where(p => p.Licenca.Equals(licenca));
