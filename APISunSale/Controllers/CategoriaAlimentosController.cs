...
using MainViewModel = Domain.ViewModel.CategoriaAlimentosViewModel;
using MainEntity = Domain.Entities.CategoriaAlimentos;
using Service = Application.Interface.Services.ICategoriaAlimentosService;
...
namespace APISunSale.Controllers
{
    ...
    public class CategoriaAlimentosController
    {
        ...
        public CategoriaAlimentosController(ILogger<AcaoUsuarioController> logger, Service service, IMapper mapper, LoggerService loggerService)
        {
            _logger = logger;
            _service = service;
            _mapper = mapper;
