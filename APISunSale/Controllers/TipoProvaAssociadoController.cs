...
using MainViewModel = Domain.ViewModel.TipoProvaAssociadoViewModel;
using MainEntity = Domain.Entities.TipoProvaAssociado;
using Service = Application.Interface.Services.ITipoProvaAssociadoService;
...
namespace APISunSale.Controllers
{
    ...
    [Authorize]
    public class TipoProvaAssociadoController
    {
        private readonly ILogger<TipoProvaAssociadoController> _logger;
        private readonly Service _service;
        private readonly IMapper _mapper;
        private readonly LoggerService _loggerService;

        public TipoProvaAssociadoController(ILogger<TipoProvaAssociadoController> logger, Service service, IMapper mapper, LoggerService loggerService)
        {
            _logger = logger;
            _service = service;
            _mapper = mapper;
