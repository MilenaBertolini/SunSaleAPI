...
using MainViewModel = Domain.ViewModel.VerificacaoUsuarioViewModel;
using MainEntity = Domain.Entities.VerificacaoUsuario;
using Service = Application.Interface.Services.IVerificacaoUsuarioService;
...
namespace APISunSale.Controllers
{
    ...
    [Authorize]
    public class VerificacaoUsuarioController
    {
        ...
        public VerificacaoUsuarioController(ILogger<AcaoUsuarioController> logger, Service service, IMapper mapper, LoggerService loggerService)
        {
            _logger = logger;
            _service = service;
            _mapper = mapper;
