...
using MainViewModel = Domain.ViewModel.MetasViewModel;
using MainEntity = Domain.Entities.Metas;
using Service = Application.Interface.Services.IMetasService;
...
namespace APISunSale.Controllers
{
    ...
    public class MetasController
    {
        ...
        public MetasController(ILogger<MetasController> logger, Service service, IMapper mapper, LoggerService loggerService)
        {
            _logger = logger;
            _service = service;
            _mapper = mapper;
