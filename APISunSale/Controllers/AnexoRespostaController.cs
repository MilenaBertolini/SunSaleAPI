...
using MainViewModel = Domain.ViewModel.AnexoRespostaViewModel;
using MainEntity = Domain.Entities.AnexoResposta;
using Service = Application.Interface.Services.IAnexoRespostaService;
...
namespace APISunSale.Controllers
{
    ...
    [Authorize]
    public class AnexoRespostaController
    {
        private readonly ILogger<AnexoRespostaController> _logger;
        private readonly Service _service;
        private readonly IMapper _mapper;
        private readonly LoggerService _loggerService;
        private readonly MainUtils _utils;

        public AnexoRespostaController(ILogger<AnexoRespostaController> logger, Service service, IMapper mapper, LoggerService loggerService, IHttpContextAccessor httpContextAccessor, UserService userService)
        {
            _logger = logger;
            _service = service;
            _mapper = mapper;
